...
# 导出每天的公众号文章
def get_official_account_article(): 
    ...
    official_account = w.pull_list(
        pull_type=3
    )
    with open(os.path.join(project_dir, "tests\\test.json"), "w", encoding="utf-8") as f:
        json.dump(official_account, f, ensure_ascii=False, indent=4)

def main(): 
    get_official_account_article()
